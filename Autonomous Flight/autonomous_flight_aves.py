...
if __name__ == "__main__":
    ...
    cmds = drone.commands
    cmds.clear() 
    addWaypoint(cmds,40.2305057,29.0095347,HOVERING_ALTITUDE)#duz git #dummy
    addWaypoint(cmds,40.2305057,29.0095347,HOVERING_ALTITUDE)#duz git
    addWaypoint(cmds,40.23054,29.0091206,HOVERING_ALTITUDE)#sari çizgi
    ...
    addWaypoint(cmds,40.2301431,29.0095451,HOVERING_ALTITUDE)#cizgiyi gec
    addWaypoint(cmds,40.2301431,29.0095451,HOVERING_ALTITUDE) #dummy
    ...
    processflag=False
    addWaypoint(cmds,40.2301431,29.0095451,HOVERING_ALTITUDE)#cizgiyi gec
    addWaypoint(cmds,40.2302965,29.0095518,HOVERING_ALTITUDE)
    ...
    while True:
        take_water(0,0,0.2)
        print(drone.location.global_relative_frame.alt)
        if drone.location.global_relative_frame.alt <= 1.40:
            break
    take_water(0,0,0)
    time.sleep(1)
    ...
    while True:
        take_water(0,0,0.2)
        print(drone.location.global_relative_frame.alt)
        if drone.location.global_relative_frame.alt <= 4.5:
            break
    take_water(0,0,0)
